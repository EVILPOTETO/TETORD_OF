...
(function () {
  ...
  window.addEventListener("error", () => { if (document.body.classList.contains("office-mode")) return; DocumentManager.showToast("Mi Word encontró un error; tu recuperación local se mantiene si estaba activa."); });
